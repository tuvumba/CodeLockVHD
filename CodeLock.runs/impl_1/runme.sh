...
HD_PWD='X:/Documents/CodeLock/CodeLock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log codeLock_vhdl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source codeLock_vhdl.tcl -notrace
