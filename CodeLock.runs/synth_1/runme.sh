...
HD_PWD='X:/Documents/CodeLock/CodeLock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log codeLock_vhdl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source codeLock_vhdl.tcl
