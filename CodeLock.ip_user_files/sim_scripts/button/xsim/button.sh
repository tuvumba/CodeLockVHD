...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot button xil_defaultlib.button -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim button -key {Behavioral:sim_1:Functional:button} -tclbatch cmd.tcl -protoinst "protoinst_files/button.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb button.wdb xsim.dir)
